...
let third : 'a -> 'a -> 'a -> 'a -> 'a = fun w x y z -> 
      ...
      if (x > z) && (x < w) && (x < y) then x else
      if (y > w) && (y < x) && (y < z) then y else
      if (y > x) && (y < w) && (y < z) then y else
      if (y > z) && (y < w) && (y < x) then y else
...
let squares : int -> int -> int -> int = fun x y z -> 
    if (x > z) && (y > z) then ((x * x) + (y * y)) else
    if (y > x) && (z > x) then ((y * y) + (z * z)) 
        else ((z * z) + (x * x));;
...
let letterGrade : int -> string = fun x -> if x >= 93 && x <= 100 then "A" else 
      if x >= 90 && x < 93 then "A-" else
      if x >= 87 && x < 90 then "B+" else
      if x >= 83 && x < 87 then "B" else
      if x >= 80 && x < 83 then "B-" else
      if x >= 77 && x < 80 then "C+" else
      if x >= 73 && x < 77 then "C" else
      if x >= 70 && x < 73 then "C-" else
      if x >= 67 && x < 70 then "D+" else
      if x >= 63 && x < 67 then "D" else
      if x >= 60 && x < 63 then "D-" else "F";;
